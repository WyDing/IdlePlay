...
public class PickerView extends View {
    ...
    private int nColorText = 0xa3a3a3;
    ...
    public void setData(List<String> datas, String unit) {
        mDataList = datas;
        mCurrentSelected = datas.size() / 4;
        mUnit = unit;
        invalidate();
    ...
    private void init() {
        ...
        mPaint.setColor(getResources().getColor(R.color.color_171721));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        nPaint.setColor(getResources().getColor(R.color.color_a3a3a3));
    }
...
//        mPaint.setAlpha((int) ((mMaxTextAlpha - mMinTextAlpha) * scale + mMinTextAlpha));
        ...
        canvas.drawText(mDataList.get(mCurrentSelected) + mUnit, x, baseline, mPaint);
        // 绘制上方data
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        float d = (float) (MARGIN_ALPHA * mMinTextSize * position + type
                * mMoveLen);
        float scale = parabola(mViewHeight / 4.5f, d);
        float size = (mMaxTextSize - mMinTextSize) * scale + mMinTextSize;
...
//        nPaint.setAlpha((int) ((mMaxTextAlpha - mMinTextAlpha) * scale + mMinTextAlpha));
        ...
        float baseline = (float) (y - (fmi.bottom / 2.0 + fmi.top / 2.0));
        canvas.drawText(mDataList.get(mCurrentSelected + type * position) + mUnit,
