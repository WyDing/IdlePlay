package com.iwuyou.libmine.view.timeselector;
...
import com.iwuyou.libmine.utils.DateUtils;
import com.iwuyou.libmine.utils.ScreenUtil;
...
public class TimeSelector {
    ...
    private int startYear, startMonth, startDay, startHour, startMininute, endYear,
            endMonth, endDay, endHour, endMininute, minute_workStart, minute_workEnd,
            hour_workStart, hour_workEnd;
...
//        minute_text = (TextView) seletorDialog.findViewById(R.id.minute_text);
    ...
    private void loadComponent() {
        ...
        day_pv.setData(day);
        hour_pv.setData(hour , context.getResources().getString(R.string.hour));
        minute_pv.setData(minute, context.getResources().getString(R.string.minute));
