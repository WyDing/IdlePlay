...
public class MonthView extends LinearLayout {
    ...
    public void init(MonthDescriptor month, List<List<MonthCellDescriptor>> cells,
        ...
        sb.append(month.getMonth() + 1).append(getResources().getString(R.string.label_month));
        title.setText(sb.toString());
        sb.reverse();
        if (DateUtils.isCurrentMonth("" + month.getYear() + "-" + (month.getMonth() + 1))) {
            title.setTextColor(getResources().getColor(R.color.color_ff5454));
        } else {
            title.setTextColor(getResources().getColor(R.color.color_828289));
        }
        ...
        CalendarRowView weekRow1 = (CalendarRowView) grid.getChildAt(0);
        weekRow1.setVisibility(GONE);
