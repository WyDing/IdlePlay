 ...
 */
package com.libswipeview.swipe;
    ...
    public final VH onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (mSwipeMenuCreator != null) {
            ...
            if (leftMenuCount > 0) {
                ...
                swipeLeftMenuView.setOrientation(swipeLeftMenu.getOrientation() == SwipeMenu.HORIZONTAL?
            ...
            if (rightMenuCount > 0) {
                ...
                swipeRightMenuView.setOrientation(swipeRightMenu.getOrientation() == SwipeMenu.HORIZONTAL?
                        LinearLayout.HORIZONTAL : LinearLayout.VERTICAL);
